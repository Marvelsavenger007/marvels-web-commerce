...
import { Loader, Lock, Mail, LogIn, UserPlus, ArrowRight } from 'lucide-react';
        ...
        >
          <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 mt-4'>
            <form className='space-y-6' onSubmit={handleSubmit}>
              <div>
                <label htmlFor='username' className='block text-sm font-medium text-gray'>Full name</label>
              ...
              <div>
                <label htmlFor='username' className='block text-sm font-medium text-gray'>Password</label>
                <div className='mt-1 relative rounded-md shadow-sm'>
                  <div className= 'absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
              ...
              <p className='mt-8 text-center text-sm text-gray-400'>
                Not a member?{' '}
                <Link to = {"/signup"} className='text-emerald-400 hover:text-emerald-500 font-medium'>
