...
const stripePromise = loadStripe("pk_test_51RyvX50N1JTAOOblujhoNhBzasRzVfrAEsYuXlhwnko8KY0uNCCtjlFiagEVamwE8mnfZyQtcNTIxplU203KkwOZ008AZv3fbL");
...
const OrderSummary = () => {
  ...
  const handlePayment = async () => {
    try {
      ...
      // Stripe now returns a checkout URL
